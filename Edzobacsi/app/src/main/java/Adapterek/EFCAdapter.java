...
public class EFCAdapter extends RecyclerView.Adapter<EFCAdapter.MyViewHolder> implements Filterable {
    Context context;
    ExerciseForCategory efc;
    ...
    public EFCAdapter(Context context, ArrayList<String> id_list, ArrayList<String> name_list, ArrayList<String> checked_list) {
        this.context = context;
        this.exercise_id_list = id_list;
        this.exercise_name_list = name_list;
        this.checked_id_list = checked_list;
        this.efc = (ExerciseForCategory) context;
    ...
    @NonNull
    @Override
    public EFCAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inf = LayoutInflater.from(context);
        View view = inf.inflate(R.layout.row_items_with_check, parent, false);
        return new EFCAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EFCAdapter.MyViewHolder holder, int position) {
        ...
        holder.linOut.setOnClickListener(v -> {
            ...
            efc.getCheckedItems(holder.exercise_name, position);
        });
